...
const objections = [
  ...
  { q: "Сложно ли обслуживать оборудование?", a: "Нет. Система автоматизирована на 90%. Ежедневное обслуживание занимает 15 минут в день. Мы обучаем вашу команду и предоставляем подробные регламенты на каждый процесс." },
  { q: "Какая площадь помещения нужна?", a: "Минимальная площадь — от 20 м². Помещение может быть промышленным или даже подвальным при наличии вентиляции." },
