...
const objections = [
  {
    ...
    a: "Большинство наших франчайзи — бывшие наёмные работники без опыта в биотехнологиях. Очное обучение 5 дней + куратор на 6 месяцев + чат поддержки 24/7. Технология настолько отлажена, что справится человек без профильного образования. А если всё равно не получится — мы выкупаем оборудование обратно по 70% стоимости.",
  },
  {
  ...
  },
  {
    ...
    a: "Компания работает с 2013 года, выручка 280+ млн ₽ в год, 47 действующих франчайзи. Все технологии, штаммы и документы передаются вам в собственность по договору — даже если мы исчезнем, ваше производство продолжит работать. Вы не зависите от нас технологически.",
  },
  {
  ...
  },
  {
    ...
    a: "Максимум 12–15 франшиз в год — это наш потолок по качеству сопровождения. Каждый партнёр получает личного куратора. Мы отказываем 60% желающих по результатам собеседования и анализа региона. Качество, а не масштаб.",
  },
];
