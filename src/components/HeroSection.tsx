  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Биореакторы для выращивания хлореллы"
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary-foreground/90">
              Франшиза с маржинальностью от 300%
            </span>
          </motion.div>
          ...
          >
            ...
            <span className="text-emerald-glow">живой хлореллы</span>{" "}
            в своём регионе
          </motion.h1>
          ...
          >
            Готовая бизнес-модель «под ключ»: от настройки биореакторов до сбыта
            готовой продукции. Окупаемость — от 6 месяцев.
          </motion.p>
          ...
          >
            <Button size="lg" className="gradient-emerald text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-emerald-glow/30 transition-all duration-300 hover:scale-105 border-0 text-primary-foreground">
          ...
          >
            {[
              ...
              <div key={stat.label}>
                <div className="font-display text-2xl md:text-3xl font-bold text-emerald-glow">
                  {stat.value}
                </div>
