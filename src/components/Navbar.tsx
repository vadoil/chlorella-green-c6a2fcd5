        ...
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-1 md:hidden">
            <a
              ...
              className={`p-2 rounded-md ${forceScrolled ? "text-primary" : "text-primary-foreground"}`}
              title="Позвонить"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`p-2 rounded-md hover:text-[#25D366] ${forceScrolled ? "text-foreground" : "text-primary-foreground"}`}
              title="WhatsApp"
              aria-label="WhatsApp"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`p-2 rounded-md hover:text-[#0088cc] ${forceScrolled ? "text-foreground" : "text-primary-foreground"}`}
              title="Telegram"
              aria-label="Telegram"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
