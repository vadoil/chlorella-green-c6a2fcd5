...
const items = [
  ...
  { icon: Globe, title: "Полноценный продающий сайт под ваш регион", desc: "Современный сайт с интернет-магазином, эквайрингом и SEO под ваш город. Разрабатываем и обновляем мы — это входит в стоимость франшизы. Продавайте онлайн с первого дня, без затрат на разработчиков." },
];
