...
const roiData = [
  {
    label: "Прибыль после окупаемости",
    value: "2 млн ₽",
    sub: "в год чистыми",
    details:
      "После того как франшиза окупилась за 4–6 месяцев, производство выходит на стабильную чистую прибыль ~150–200 тыс. ₽ в месяц — это около 2 млн ₽ в год. Дальше масштабируется простым добавлением биореакторов.",
  },
  {
    label: "Срок окупаемости",
    value: "4–6 мес.",
    sub: "при работе на нескольких биореакторах",
    details:
      "Чем больше биореакторов работает параллельно, тем быстрее возвращаются вложения: фиксированные расходы (аренда, ФОТ, логистика) одни и те же, а выручка растёт линейно. Точные цифры считаем индивидуально под ваш регион.",
  },
  {
    ...
    details:
      "Литр живой хлореллы продаётся от 180 ₽ опт и до 350 ₽ розница. Себестоимость складывается из питательной среды, электричества, воды, упаковки и логистики. Наценка x10–x20.",
  },
  {
    label: "Рост мирового рынка",
    value: "+50%",
    sub: "за ближайшие 5 лет",
    details:
      "По данным Mordor Intelligence и Grand View Research мировой рынок хлореллы растёт на 8–10% в год — это +50% накопленным итогом к 2030. В России спрос подогревают рыбоводство, БАДы, косметика и эко-фермерство — конкуренция в регионах минимальная.",
  },
];
