...
const roiData = [
  {
    ...
    details:
      "Живая хлорелла — продукт с высокой добавленной стоимостью: оптовая цена в разы превышает себестоимость. По мере роста объёмов постоянные расходы размазываются, и маржа стабильно держится выше 55%.",
  },
  {
